...
Currently implemented:
  - deepgram_transcription: audio (file or URL) → the `transcript` state object.

Still to build: the calendar-watcher (roster + meeting_metadata) and the meeting
bot (audio capture + participant display names).
"""
...
__all__ = ["DeepgramError", "transcribe_file", "transcribe_url"]
